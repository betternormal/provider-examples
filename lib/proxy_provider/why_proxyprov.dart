...
// Although the numbers are changing in the console, they are not being applied to the UI because the create function of the provider is only called once initially.
